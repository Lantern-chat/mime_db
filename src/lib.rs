...
pub fn from_prefix(bytes: &[u8]) -> Option<(&str, Option<&MimeEntry>)> {
    ...
    static MAGIC_BYTES: &[(usize, &[u8], &str)] = &[
        ...
        (0, &[0x69, 0x63, 0x6e, 0x73], "image/x-icns"),
        ...
        (
            0, &[0x66, 0x74, 0x79, 0x70, 0x68, 0x65, 0x69, 0x63, 0x66, 0x74, 0x79, 0x70, 0x6d],
            "image/heic",
        ),
        (4, b"ftyp3g", "video/3gpp"),
        (0, &[0x76, 0x2f, 0x31, 0x01], "image/x-exr"), // = &exr::meta::magic_number::BYTES
        ...
        (0, &[0x00, 0x00, 0x00, 0x0C, 0x4A, 0x58, 0x4C, 0x20, 0x0D, 0x0A, 0x87, 0x0A], "image/jxl"),
        (0, &[0x49, 0x44, 0x33], "audio/mp3"),
        (0, &[0x4F, 0x54, 0x54, 0x4F], "font/otf"),
        (0, &[0x00, 0x01, 0x00, 0x00, 0x00], "font/ttf"),
        (0, &[0x66, 0x4C, 0x61, 0x43], "audio/x-flac"),
        (
            0, &[0x00, 0x00, 0x00, 0x0C, 0x4A, 0x58, 0x4C, 0x20, 0x0D, 0x0A, 0x87, 0x0A],
            "image/jxl",
        ),
        ...
        (
            257, &[0x75, 0x73, 0x74, 0x61, 0x72, 0x00, 0x30, 0x30],
            "application/tar",
        ),
        (
            257, &[0x75, 0x73, 0x74, 0x61, 0x72, 0x20, 0x20, 0x00],
            "application/tar",
        ),
        (
        ...
        (0, b"FLhd", "application/vnd.fl-studio"),
        (0, b"#EXTM3U", "audio/mpegurl"),
        (
            0, &[0x42, 0x4C, 0x45, 0x4E, 0x44, 0x45, 0x52],
            "application/x-blend",
        ),
        (0, &[0x46, 0x4C, 0x56], "video/x-flv"),
        (0, &[0x4D, 0x53, 0x43, 0x46], "application/vnd.ms-cab-compressed"),
        (
            0, &[0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9, 0x00, 0xAA, 0x00, 0x62, 0xCE, 0x6C],
            "video/x-ms-wmv",
        ),
        (
            0, &[
        ...
        (
            0, &[0x06, 0x06, 0xED, 0xF5, 0xD8, 0x1D, 0x46, 0xE5, 0xBD, 0x31, 0xEF, 0xE7, 0xFE, 0x74, 0xB7, 0x1D],
